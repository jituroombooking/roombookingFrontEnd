  ...
  const paymentMarking = () => {
    ...
    dispatch(
      ...
      if (markAttendenc.payload.status === 200) {
        dispatch(
          getAttendence({ id: currentLabourData?._id, firstDay, lastDay })
        ).then((getAttendenceRes) => {
